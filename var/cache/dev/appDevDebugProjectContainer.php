...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' => 'get17e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service',
            '2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' => 'get27e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service',
            'AppBundle\\Controller\\DefaultController' => 'getAppBundle_Controller_DefaultControllerService',
            'annotation_reader' => 'getAnnotationReaderService',
            'annotations.reader' => 'getAnnotations_ReaderService',
            'app.photo_service' => 'getApp_PhotoServiceService',
            ...
            'console.command.appbundle_command_createpost' => 'getConsole_Command_AppbundleCommandCreatepostService',
            'console.command.appbundle_command_createpost_app.create_post' => 'getConsole_Command_AppbundleCommandCreatepostApp_CreatePostService',
            'console.command.appbundle_command_primarywallparse' => 'getConsole_Command_AppbundleCommandPrimarywallparseService',
            'console.command.appbundle_command_uploadphoto' => 'getConsole_Command_AppbundleCommandUploadphotoService',
            'console.command.appbundle_command_uploadphoto_app.upload_photo' => 'getConsole_Command_AppbundleCommandUploadphotoApp_UploadPhotoService',
            'console.command.appbundle_command_wallparse' => 'getConsole_Command_AppbundleCommandWallparseService',
            'console.command.appbundle_command_wallparse_app.wall_parse' => 'getConsole_Command_AppbundleCommandWallparseApp_WallParseService',
        ...
        $this->privates = array(
            '1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' => true,
            '2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' => true,
            'annotations.reader' => true,
            'app.photo_service' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419']) ? $this->services['1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419'] : $this->get17e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419']) ? $this->services['2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419'] : $this->get27e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service()) && false ?: '_'};
        }, 2));
    }

    /**
     * Gets the 'console.command.appbundle_command_createpost' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Command\CreatePost A AppBundle\Command\CreatePost instance
     */
    protected function getConsole_Command_AppbundleCommandCreatepostService()
    {
        return $this->services['console.command.appbundle_command_createpost'] = new \AppBundle\Command\CreatePost();
    }

    /**
     * Gets the 'console.command.appbundle_command_createpost_app.create_post' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \AppBundle\Command\CreatePost A AppBundle\Command\CreatePost instance
     */
    protected function getConsole_Command_AppbundleCommandCreatepostApp_CreatePostService()
    {
        $a = new \getjump\Vk\Core();
        $a->apiVersion('5.5');
        $a->setToken('b2051944f22d9dcf6f28e3819a25ceabcf2a4557d99e0ea50a7362e63088ad7d837b4eb12d3e9c00c0771');

        return $this->services['console.command.appbundle_command_createpost_app.create_post'] = new \AppBundle\Command\CreatePost(call_user_func(array($a, 'getInstance')), ${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'}, ${($_ = isset($this->services['app.photo_service']) ? $this->services['app.photo_service'] : $this->getApp_PhotoServiceService()) && false ?: '_'});
    }

    /**
     * Gets the 'console.command.appbundle_command_primarywallparse' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Command\PrimaryWallParse A AppBundle\Command\PrimaryWallParse instance
     */
    protected function getConsole_Command_AppbundleCommandPrimarywallparseService()
    {
        return $this->services['console.command.appbundle_command_primarywallparse'] = new \AppBundle\Command\PrimaryWallParse(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the 'console.command.appbundle_command_uploadphoto' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Command\UploadPhoto A AppBundle\Command\UploadPhoto instance
     */
    protected function getConsole_Command_AppbundleCommandUploadphotoService()
    {
        return $this->services['console.command.appbundle_command_uploadphoto'] = new \AppBundle\Command\UploadPhoto(new \AppBundle\Service\PhotoService());
    }

    /**
     * Gets the 'console.command.appbundle_command_uploadphoto_app.upload_photo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Appbundle\Command\UploadPhoto A Appbundle\Command\UploadPhoto instance
     */
    protected function getConsole_Command_AppbundleCommandUploadphotoApp_UploadPhotoService()
    {
        return $this->services['console.command.appbundle_command_uploadphoto_app.upload_photo'] = new \Appbundle\Command\UploadPhoto(${($_ = isset($this->services['app.photo_service']) ? $this->services['app.photo_service'] : $this->getApp_PhotoServiceService()) && false ?: '_'});
    }

    /**
     * Gets the 'console.command.appbundle_command_wallparse' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * This service is autowired.
     *
     * @return \AppBundle\Command\WallParse A AppBundle\Command\WallParse instance
     */
    protected function getConsole_Command_AppbundleCommandWallparseService()
    {
        return $this->services['console.command.appbundle_command_wallparse'] = new \AppBundle\Command\WallParse(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the 'console.command.appbundle_command_wallparse_app.wall_parse' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \AppBundle\Command\WallParse A AppBundle\Command\WallParse instance
     */
    protected function getConsole_Command_AppbundleCommandWallparseApp_WallParseService()
    {
        return $this->services['console.command.appbundle_command_wallparse_app.wall_parse'] = new \AppBundle\Command\WallParse(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlite', 'path' => ($this->targetDirs[3].'/app/sqlite.db'), 'charset' => 'UTF8', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7bcb8b8f198915bbc2c031c8c193bd3a7940bd31c32b4c621768b33cab32dd91');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0f6de18dce144409f8eb1358967039cc8e84d0d1');
    }
    ...
    /**
     * Gets the '1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get17e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service()
    {
        return $this->services['1_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get27e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419Service()
    {
        return $this->services['2_7e082ec39ffbd13cf0c570293282cb37ecf8d26f40b6960f0346babf48c60419'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    /**
     * Gets the 'app.photo_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * This service is autowired.
     *
     * @return \AppBundle\Service\PhotoService A AppBundle\Service\PhotoService instance
     */
    protected function getApp_PhotoServiceService()
    {
        return $this->services['app.photo_service'] = new \AppBundle\Service\PhotoService();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-eklAKRMYx', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kZMW+jSt37', 0, 'qSd7ngr85tmddFkAsqujS8', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yCDN+V4R3S', 0, 'qSd7ngr85tmddFkAsqujS8', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s95MSDNBbh', 0, 'qSd7ngr85tmddFkAsqujS8', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('595aadb7847a89.54975661');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '0f6de18dce144409f8eb1358967039cc8e84d0d1',
            ...
            'kernel.secret' => '0f6de18dce144409f8eb1358967039cc8e84d0d1',
            ...
            'console.command.ids' => array(
                'console.command.appbundle_command_createpost' => 'console.command.appbundle_command_createpost',
                'console.command.appbundle_command_primarywallparse' => 'console.command.appbundle_command_primarywallparse',
                'console.command.appbundle_command_uploadphoto' => 'console.command.appbundle_command_uploadphoto',
                'console.command.appbundle_command_wallparse' => 'console.command.appbundle_command_wallparse',
                'console.command.appbundle_command_wallparse_app.wall_parse' => 'console.command.appbundle_command_wallparse_app.wall_parse',
                'console.command.appbundle_command_uploadphoto_app.upload_photo' => 'console.command.appbundle_command_uploadphoto_app.upload_photo',
                'console.command.appbundle_command_createpost_app.create_post' => 'console.command.appbundle_command_createpost_app.create_post',
